...
class AcquirerAreeba(models.Model):
    ...
    def areeba_form_generate_values(self, values):
        ...
        url = 'https://ap-gateway.mastercard.com/api/rest/version/55/merchant/%s/session' % self.areeba_merchant_id
        data = {
...
class TxAreeba(models.Model):
    ...
    def form_feedback(self, data, acquirer_name):
        if data and acquirer_name == "areeba":
            ...
            url = 'https://epayment.areeba.com/api/rest/version/55/merchant/%s/order/%s' % (acquirer.areeba_merchant_id, data)
