...
class GeneralLedgerMultiCurrencyCustomHandler(models.AbstractModel):
    _name = 'account.general.ledger.multi.currency.report.handler'
    _inherit = 'account.report.custom.handler'
    _description = 'General Ledger Multi Currency Custom Handler'
    ...
    def _dynamic_lines_generator(self, report, options, all_column_groups_expression_totals):
        ...
        totals_by_column_group = defaultdict(lambda: {'debit': 0, 'debit2': 0, 'credit': 0, 'credit2': 0, 'balance': 0})
        for account, column_group_results in self._query_values(report, options):
            ...
            for column_group_key, results in column_group_results.items():
                ...
                account_debit2 = account_sum.get('debit2', 0.0) + account_un_earn.get('debit2', 0.0)
                account_credit = account_sum.get('credit', 0.0) + account_un_earn.get('credit', 0.0)
                account_credit2 = account_sum.get('credit2', 0.0) + account_un_earn.get('credit2', 0.0)
                ...
                eval_dict[column_group_key] = {
                    ...
                    'debit': account_debit,
                    'debit2': account_debit2,
                    'credit': account_credit,
                    'credit2': account_credit2,
                ...
                totals_by_column_group[column_group_key]['debit2'] += account_debit2
                totals_by_column_group[column_group_key]['credit'] += account_credit
                totals_by_column_group[column_group_key]['credit2'] += account_credit2
    ...
    def _get_aml_values(self, report, options, expanded_account_ids, offset=0, limit=None):
        ...
        for aml_result in self._cr.dictfetchall():
            ...
            if already_present_result:
                ...
                already_present_result['debit2'] += aml_result['debit2']
                already_present_result['credit'] += aml_result['credit']
                already_present_result['credit2'] += aml_result['credit2']
        ...
        for column_group_key, group_options in report._split_options_per_column_group(options).items():
            ...
            query = f'''
                (SELECT
                    ...
                    account_move_line.company_currency_id2,
                    ...
                    company.currency_id2                     AS company_currency_id2,
        ...
        for column in options['columns']:
            ...
            if col_value is None or (col_expr_label == 'amount_currency' and not account.currency_id):
                ...
                if col_expr_label == 'amount_currency':
                    ...
                    formatted_value = report.format_value(col_value, currency=self.env.company.currency_id2, figure_type=column['figure_type'])
                else:
        ...
        for column in options['columns']:
            ...
            if col_value is None:
                ...
                if col_expr_label == 'amount_currency':
                    ...
                    formatted_value = report.format_value(col_value, currency=self.env.company.currency_id2, figure_type=column['figure_type'], blank_if_zero=False)
                else:
                    formatted_value = report.format_value(col_value, figure_type=column['figure_type'])
    ...
    def _get_total_line(self, report, options, eval_dict):
        ...
        for column in options['columns']:
            ...
            if col_value is None:
                ...
                if column['name'] in ['Debit2', 'Credit2']:
                    formatted_value = report.format_value(col_value, currency=self.env.company.currency_id2, blank_if_zero=False, figure_type='monetary')
                else:
